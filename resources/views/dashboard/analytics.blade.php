                    ...
                    <div class="panel h-full">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="h-5 w-full overflow-hidden rounded-full bg-dark-light p-1 shadow-3xl dark:bg-dark-light/10 dark:shadow-none">
                                <div class="relative h-full w-full rounded-full bg-gradient-to-r from-[#4361ee] to-[#805dca] before:absolute before:inset-y-0 before:m-auto before:h-2 before:w-2 before:rounded-full before:bg-white ltr:before:right-0.5 rtl:before:left-0.5" style="width: 65%"></div>
                            </div>
                            <span class="ltr:ml-5 rtl:mr-5 dark:text-white-light">57%</span>
                        </div>
                    </div>

                    <div class="panel grid h-full grid-cols-1 content-between overflow-hidden before:absolute before:-right-44 before:top-0 before:bottom-0 before:m-auto before:h-96 before:w-96 before:rounded-full before:bg-[#1937cc]" style="background: linear-gradient(0deg, #00c6fb -227%, #005bea) !important">
                        ...
                        <div class="z-10 flex items-center justify-between">
                            <div class="flex items-center justify-between">
                                <a href="javascript:;" class="place-content-center rounded p-1 text-white-light shadow-[0_0_2px_0_#bfc9d4] hover:bg-[#1937cc] ltr:mr-2 rtl:ml-2">
                                    <svg class="h-5 w-5" viewbox="0 0 24 24" stroke="currentColor" stroke-width="1.5" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <a href="javascript:;" class="z-10 rounded p-1 text-white-light shadow-[0_0_2px_0_#bfc9d4] hover:bg-[#4361ee]">
                                Upgrade
                            </a>
                        </div>
                    </div>
                ...
                <div class="mb-6 grid gap-6 lg:grid-cols-3">
                    ...
                    <div class="panel h-full">
                        ...
                        <div class="perfect-scrollbar relative -mr-3 h-[360px] pr-3">
                            <div class="space-y-7">
                                <div class="flex">
                                    <div class="relative z-10 shrink-0 before:absolute before:top-10 before:left-4 before:h-[calc(100%-24px)] before:w-[2px] before:bg-white-dark/30 ltr:mr-2 rtl:ml-2">
                                    ...
                                    <div>
                                        <h5 class="font-semibold dark:text-white-light">
                                            New project created : <a href="javascript:;" class="text-success">[StarCode Kh Admin Template]</a>
                                        </h5>
                        ...
                        <div class="flex flex-col space-y-5">
                            <div class="flex items-center">
                                ...
                                <div class="w-full flex-initial px-3">
                                    ...
                                    <div>
                                        <div class="h-5 w-full overflow-hidden rounded-full bg-dark-light p-1 shadow-3xl dark:bg-dark-light/10 dark:shadow-none">
                                            <div class="relative h-full w-full rounded-full bg-gradient-to-r from-[#009ffd] to-[#2a2a72] before:absolute before:inset-y-0 before:m-auto before:h-2 before:w-2 before:rounded-full before:bg-white ltr:before:right-0.5 rtl:before:left-0.5" style="width: 65%"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center">
                                ...
                                <div class="w-full flex-initial px-3">
                                    ...
                                    <div>
                                        <div class="h-5 w-full overflow-hidden rounded-full bg-dark-light p-1 shadow-3xl dark:bg-dark-light/10 dark:shadow-none">
                                            <div class="relative h-full w-full rounded-full bg-gradient-to-r from-[#a71d31] to-[#3f0d12] before:absolute before:inset-y-0 before:m-auto before:h-2 before:w-2 before:rounded-full before:bg-white ltr:before:right-0.5 rtl:before:left-0.5" style="width: 40%"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="flex items-center">
                                ...
                                <div class="w-full flex-initial px-3">
                                    ...
                                    <div>
                                        <div class="h-5 w-full overflow-hidden rounded-full bg-dark-light p-1 shadow-3xl dark:bg-dark-light/10 dark:shadow-none">
                                            <div class="relative h-full w-full rounded-full bg-gradient-to-r from-[#fe5f75] to-[#fc9842] before:absolute before:inset-y-0 before:m-auto before:h-2 before:w-2 before:rounded-full before:bg-white ltr:before:right-0.5 rtl:before:left-0.5" style="width: 25%"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel h-full">
                        <div class="-m-5 mb-5 flex items-start border-b border-[#e0e6ed] p-5 dark:border-[#1b2e4b]">
                            <div class="shrink-0 rounded-full ring-2 ring-white-light ltr:mr-4 rtl:ml-4 dark:ring-dark">
                                <img src="{{ asset('assets/images/user-profile.jpeg') }}" alt="image" class="h-10 w-10 rounded-full object-cover">
                            </div>
                        ...
                        <div>
                            ...
                            <div class="absolute bottom-0 -mx-5 flex w-full items-center justify-between p-5">
                                <div class="flex items-center">
                                    <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="relative -top-0.5 inline h-5 w-5 text-info ltr:mr-1.5 rtl:ml-1.5">
                                ...
                                <a href="javascript:;" class="flex items-center rounded-md bg-success/30 px-1.5 py-1 text-xs text-success hover:shadow-[0_10px_20px_-10px] hover:shadow-success">Read More
                    ...
                    <div class="panel h-full">
                        <div class="-m-5 mb-5 flex items-center justify-between border-b border-[#e0e6ed] p-5 dark:border-[#1b2e4b]">
                            <div class="flex">
                                <div class="media-aside align-self-start">
                                    <div class="shrink-0 rounded-full ring-2 ring-white-light ltr:mr-4 rtl:ml-4 dark:ring-dark">
                                        <img src="{{ asset('assets/images/g-8.png') }}" alt="image" class="h-10 w-10 rounded-full object-cover">
                                    </div>
                                </div>
                                <div class="font-semibold">
                        ...
                        <div class="pb-8 text-center font-semibold">
                            ...
                            <div class="flex items-center justify-center gap-3 pb-8">
                                <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="{{ asset('assets/images/user-profile.jpeg') }}" alt="image">
                                <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="{{ asset('assets/images/user-profile.jpeg') }}" alt="image">
                                <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="{{ asset('assets/images/user-profile.jpeg') }}" alt="image">
                                <img class="h-10 w-10 overflow-hidden rounded-lg object-cover ring-2 ring-white-light dark:ring-dark" src="{{ asset('assets/images/user-profile.jpeg') }}" alt="image">
                            </div>
                        ...
                        <div class="group">
                            <div class="mb-5">
                                <div class="text-white-dark">
                                    Doloribus nisi vel suscipit modi, optio ex repudiandae voluptatibus officiis commodi. Nesciunt quas aut neque
                                    incidunt!
                                </div>
                            </div>
                            ...
                            <div class="flex items-end justify-between">
                                ...
                                <div class="flex items-center justify-center group-hover:-space-x-2 rtl:space-x-reverse rtl:group-hover:space-x-reverse">
                                    <span class="flex h-9 w-9 items-center justify-center rounded-full bg-[#bfc9d4] font-semibold text-white opacity-0 transition-all duration-300 group-hover:opacity-100 dark:bg-dark">+6</span>
                                    <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark" src="{{ asset('assets/images/user-profile.jpeg') }}" alt="image">
                                    <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark" src="{{ asset('assets/images/user-profile.jpeg') }}" alt="image">
                                    <img class="h-9 w-9 rounded-full border-2 border-white object-cover transition-all duration-300 dark:border-dark" src="{{ asset('assets/images/user-profile.jpeg') }}" alt="image">
                                </div>
                            </div>
