...
class="relative">
    ...
    <div 
        ...
        class="absolute right-0 z-50 {{ isset($buttonClass) && str_contains($buttonClass, 'bg-brand-500') ? 'bottom-full mb-2 origin-bottom-right' : 'top-full mt-2 origin-top-right' }} w-56 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-gray-800 max-h-[200px] overflow-y-auto"
        role="menu" 
