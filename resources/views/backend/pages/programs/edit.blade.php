<x-layouts.backend-layout :breadcrumbs="$breadcrumbs">
    ...
    <form action="{{ route('admin.programs.update', $program->id) }}" method="POST" enctype="multipart/form-data" x-data="programForm()">
        @csrf
        @method('PUT')
        @include('backend.pages.programs.partials.form', ['program' => $program])
    </form>
