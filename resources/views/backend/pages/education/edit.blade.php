    ...
    <div class="space-y-6">
        <div class="rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-white/[0.03]">
            ...
            <div class="p-5 sm:p-6">
                <form action="{{ route('admin.education.update', $document->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           id="author"
                                           name="author"
                                           value="{{ old('author', $document->creator) }}"
                                           required
                                           class="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent dark:text-white">
                                    @error('author')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select id="document_type"
                                        ...
                                        @foreach($documentTypes as $type)
                                            <option value="{{ $type }}" {{ old('document_type', $document->resource_type) == $type ? 'selected' : '' }}>
                                                {{ $type }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select id="category"
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->name }}" {{ old('category', $document->subject_area) == $category->name ? 'selected' : '' }}>
                                                {{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           id="version"
                                           name="version"
                                           value="{{ old('version', $document->version ?? '1.0') }}"
                                           placeholder="1.0"
                                           class="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent dark:text-white">
                                </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400">
                                                {{ $document->file_size_formatted }} @if (!empty($document->file_extension)) • {{ strtoupper($document->file_extension) }} @endif
                                            </p>
                                        </div>
                                    </div>
                    ...
                    <div class="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-600">
                        <a href="{{ route('admin.education.index') }}" class="btn-default">
                            {{ __('Cancel') }}
                        </a>
