        ...
        <div class="px-6 pb-6 space-y-4 flex-1 overflow-y-auto">
            ...
            <div class="space-y-2">
                <label for="ai_prompt" class="form-label">
                    {{ __('Describe your news content') }}
                </label>
                <textarea
                    x-model="prompt"
                    id="ai_prompt"
                    rows="4"
                    placeholder="{{ __('Example: Write a news article about the latest developments in renewable energy technology, focusing on solar panel efficiency improvements...') }}"
                    class="form-control-textarea"
                    maxlength="1000"
                ></textarea>
                <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400">
                    <span>{{ __('Be specific about your news topic and angle') }}</span>
            ...
            <div class="flex justify-center pt-2">
                ...
                >
                    ...
                    <span x-show="!loading">{{ __('Generate News') }}</span>
            ...
            <div x-show="generatedContent.title" class="mt-6 space-y-4 border-t border-gray-200 dark:border-gray-700 pt-6">
                <h4 class="text-sm font-medium text-gray-900 dark:text-white">{{ __('Generated News Preview') }}</h4>
        ...
        return {
            ...
            insertContent() {
                ...
                if (typeof window.showToast === 'function') {
                    window.showToast('success', 'Success', 'AI news content inserted successfully!');
                }
