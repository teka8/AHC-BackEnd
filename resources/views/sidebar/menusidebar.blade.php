        ...
        <div class="h-full bg-white dark:bg-[#0e1726]">
            ...
            <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'dashboard' }">
                <li class="menu nav-item">
                    ...
                    <ul x-cloak x-show="activeDropdown === 'dashboard'" x-collapse x-init=" 
                        if ('{{ x_show(['home','analytics','finance','crypto']) }}' === 'true') { activeDropdown = 'dashboard'
                            } else {
                ...
                <li class="nav-item">
                    <ul>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('apps/todolist') }}" class="{{ set_active(['apps/todolist']) }} group">
                                <div class="flex items-center">
                                    <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('apps/notes') }}" class="{{ set_active(['apps/notes']) }} group">
                                <div class="flex items-center">
                                    <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.5" d="M3 10C3 6.22876 3 4.34315 4.17157 3.17157C5.34315 2 7.22876 2 11 2H13C16.7712 2 18.6569 2 19.8284 3.17157C21 4.34315 21 6.22876 21 10V14C21 17.7712 21 19.6569 19.8284 20.8284C18.6569 22 16.7712 22 13 22H11C7.22876 22 5.34315 22 4.17157 20.8284C3 19.6569 3 17.7712 3 14V10Z" fill="currentColor"></path>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('apps/scrumboard') }}" class="{{ set_active(['apps/scrumboard']) }} group">
                                <div class="flex items-center">
                                    <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('apps/contacts') }}" class="{{ set_active(['apps/contacts']) }} group">
                                <div class="flex items-center">
                                    <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li class="menu nav-item">
                            ...
                            <ul x-cloak x-show="activeDropdown === 'invoice'" x-collapse x-init="if ('{{ x_show(['apps/invoice/list','apps/invoice/preview','apps/invoice/add','apps/invoice/edit']) }}' === 'true') activeDropdown = 'invoice'" class="sub-menu text-gray-500">
                                <li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('apps/calendar') }}" class="{{ set_active(['apps/calendar']) }} group">
                                <div class="flex items-center">
                                    <svg class="shrink-0 group-hover:!text-primary" width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="menu nav-item">
                    <button type="button"
                        class="nav-link group {{ set_active(['users/profile','users/account/settings']) }}"
                        ...
                        <div class="rtl:rotate-180" :class="{'!rotate-90' : activeDropdown === 'users'}">
                            <svg width="16" height="16" viewBox="0 0 24 24">
                                <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                            </svg>
                        </div>
                    </button>

                    <ul x-cloak x-show="activeDropdown === 'users'" x-collapse x-init="if ('{{ x_show(['users/profile','users/account/settings']) }}' === 'true') activeDropdown = 'users'" class="sub-menu text-gray-500">
                        <li>
