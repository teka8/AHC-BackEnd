                ...
                <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-3 xl:grid-cols-4">
                    <div class="panel">
                        <div class="mb-5 flex items-center justify-between">
                            ...
                            <a href="{{ route('users/account/settings') }}" class="btn btn-primary rounded-full p-2 ltr:ml-auto rtl:mr-auto">
                        ...
                        <div class="mb-5">
                            <div class="flex flex-col items-center justify-center">
                                <img src="{{ asset('assets/images/profile-34.jpeg') }}" alt="image" class="mb-5 h-24 w-24 rounded-full object-cover">
