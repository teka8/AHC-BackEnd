                ...
                <div class="panel absolute z-10 hidden w-full max-w-xs flex-none space-y-4 overflow-hidden p-4 xl:relative xl:block xl:h-full" :class="isShowChatMenu && '!block'">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            <div class="flex-none"><img src="{{ asset('assets/images/profile-34.jpeg') }}" class="h-12 w-12 rounded-full object-cover"></div>
                            <div class="mx-3">
                        ...
                        <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                            <button type="button" class="flex h-8 w-8 items-center justify-center rounded-full bg-[#f4f4f4] hover:bg-primary-light dark:bg-[#1b2e4b]" @click="toggle">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex items-center">
                                            <div class="relative flex-shrink-0">
                                                <img :src="`{{ asset('assets/images/profile-34.jpeg') }}`" class="h-12 w-12 rounded-full object-cover">
                            ...
                            <div class="flex items-center justify-between p-4">
                                <div class="flex items-center space-x-2 rtl:space-x-reverse">
                                    ...
                                    <div class="relative flex-none">
                                        <img :src="`{{ asset('assets/images/profile-34.jpeg') }}`" class="h-10 w-10 rounded-full object-cover sm:h-12 sm:w-12">
                                        <div class="absolute bottom-0 ltr:right-0 rtl:left-0">
                                            <div class="h-4 w-4 rounded-full bg-success"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex gap-3 sm:gap-5">
                                    ...
                                    <div x-data="dropdown" @click.outside="open = false" class="dropdown">
                                        ...
                                        <ul x-cloak="" x-show="open" x-transition="" x-transition.duration.300ms="" class="ltr:right-0 rtl:left-0">
                                            <li>
                                                <a href="javascript:;" @click="toggle">
                                                    <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0 ltr:mr-2 rtl:ml-2">
                                                        <circle cx="11.5" cy="11.5" r="9.5" stroke="currentColor" stroke-width="1.5" opacity="0.5"></circle>
                                                        <path d="M18.5 18.5L22 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                                    </svg>
                                                    Search
                                            ...
                                            <li>
                                                <a href="javascript:;" @click="toggle">
                                                    <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2">
                                                        <path d="M9 11.5C9 12.8807 7.88071 14 6.5 14C5.11929 14 4 12.8807 4 11.5C4 10.1193 5.11929 9 6.5 9C7.88071 9 9 10.1193 9 11.5Z" stroke="currentColor" stroke-width="1.5"></path>
                                                        <path opacity="0.5" d="M14.3206 16.8017L9 13.29" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                                        <path opacity="0.5" d="M14.4207 6.83984L9.1001 10.3515" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"></path>
                                        ...
                                        <div class="flex items-start gap-3" :class="{'justify-end' : selectedUser.userId === message.fromUserId}">
                                            <div class="flex-none" :class="{'order-2' : selectedUser.userId === message.fromUserId}">
                                                <template x-if="selectedUser.userId === message.fromUserId">
                                                    <img :src="`{{ asset('assets/images/profile-34.jpeg') }}`" class="h-10 w-10 rounded-full object-cover">
                                                </template>
                                                <template x-if="selectedUser.userId !== message.fromUserId">
                                                    <img :src="`{{ asset('assets/images/profile-34.jpeg') }}`" class="h-10 w-10 rounded-full object-cover">
                                                </template>
