                ...
                <div class="px-5">
                    <div class="md:absolute md:top-5 ltr:md:left-5 rtl:md:right-5">
                        <div class="mb-5 flex items-center gap-2">
                            ...
                            <a href="{{ route('apps/invoice/add') }}" class="btn btn-primary gap-2">
                        ...
                        this.datatable = new simpleDatatables.DataTable('#myTable', {
                            ...
                            columns: [
                                ...
                                },
                                {
                                    select: 2,
                                    render: function (data, cell, row) {
                                        return `<div class="flex items-center font-semibold"><div class="p-0.5 bg-white-dark/30 rounded-full w-max ltr:mr-2 rtl:ml-2"><img class="h-8 w-8 rounded-full object-cover" src="{{ asset('assets/images/profile-${
                                            row.dataIndex + 1
                                        }.jpeg') }}" /></div>${data}</div>`;
                                    },
                                },
