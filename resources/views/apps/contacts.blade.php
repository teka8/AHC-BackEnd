                                        ...
                                        <td>
                                            <div class="flex w-max items-center">
                                                <div class="flex-none mr-3">
                                                    <div class="p-1 bg-white-dark/30 rounded-full"><img class="h-8 w-8 rounded-full object-cover" src="{{ asset('assets/images/user-profile.jpeg') }}" /></div>
                                                </div>
                        ...
                        <div class="relative overflow-hidden rounded-md bg-white text-center shadow dark:bg-[#1c232f]">
                            <div class="rounded-t-md bg-white/40 bg-[url('../images/notification-bg.png')] bg-cover bg-center p-6 pb-0">
                                <template x-if="contact.path">
                                    <img class="mx-auto max-h-40 w-4/5 object-contain" src="{{ asset('assets/images/user-profile.jpeg') }}" alt="contact image" />
                                </template>
                            </div>
