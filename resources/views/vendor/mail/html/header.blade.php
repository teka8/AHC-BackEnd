...
<tr>
    <td align="center">
        <table align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
                <td class="header"
                    style="background-color: #7AC943; padding: 25px 0 20px 0; text-align: center; border-bottom: 5px solid #5A9E31; border-radius: 12px 12px 0 0;">
                                        ...
                                        <td align="left" style="vertical-align: middle; text-align: left; padding: 0;">
                                            <a href="{{ config('app.frontend_url') ?? url('/') }}" style="display: inline-block; text-decoration: none;">
                                                <img src="https://ahc.aau.edu.et/images/logo_white.png" alt="AHC" height="40"
                                                    style="vertical-align: middle; margin-right: 15px; max-height: 40px; display: inline-block; border: none;">
                                                <img src="https://ahc.aau.edu.et/images/partners/Addis_Ababa_University_logo.png"
                                                    alt="AAU" height="40" style="vertical-align: middle; max-height: 40px; display: inline-block; border: none;">
                                            </a>
                                        </td>
                                    </tr>
                                </table>
                                        ...
                                        <td align="right" style="vertical-align: middle; text-align: right; padding: 0;">
                                            <a href="{{ config('app.frontend_url') ?? url('/') }}" style="display: inline-block; text-decoration: none;">
                                                <img src="https://ahc.aau.edu.et/images/partners/mastercard_foundation_-_logo.png"
                                                    ...
                                                    style="vertical-align: middle; max-height: 40px; display: block; border: none;">
                                            </a>
                                        </td>
                                    </tr>
                                </table>
