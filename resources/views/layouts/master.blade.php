                            ...
                            <div x-data="header" class="flex items-center space-x-1.5 ltr:ml-auto rtl:mr-auto rtl:space-x-reverse dark:text-[#d0d2d6] sm:flex-1 ltr:sm:ml-0 sm:rtl:mr-0 lg:space-x-2">
                                ...
                                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                                    ...
                                    <ul x-cloak="" x-show="open" x-transition="" x-transition.duration.300ms="" class="top-11 w-[230px] !py-0 font-semibold text-dark ltr:right-0 rtl:left-0 dark:text-white-dark dark:text-white-light/90">
                                        ...
                                        <li>
                                            <a href="{{ route('apps/mailbox') }}" class="dark:hover:text-white" @click="toggle">
                                                <svg class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2" width="18" height="18" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <li>
                                            <a href="{{ route('lockscreen') }}" class="dark:hover:text-white" @click="toggle">
                                                <svg class="h-4.5 w-4.5 shrink-0 ltr:mr-2 rtl:ml-2" width="18" height="18" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="horizontal-menu hidden border-t border-[#ebedf2] bg-white px-6 py-1.5 font-semibold text-black rtl:space-x-reverse dark:border-[#191e3a] dark:bg-[#0e1726] dark:text-white-dark lg:space-x-1.5 xl:space-x-8">
                            <li class="menu nav-item relative">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li>
                                        <a href="{{ route('analytics') }}" class="{{ set_active(['analytics']) }}">Analytics</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('finance') }}" class="{{ set_active(['finance']) }}">Finance</a>
                                    </li>
                                    <li>
                            ...
                            <li class="menu nav-item relative">
                                <a href="javascript:;" class="nav-link {{ set_active(['apps/chat','apps/mailbox','apps/todolist','apps/notes','apps/scrumboard','apps/contacts',
                                    'apps/invoice/list','apps/invoice/preview','apps/invoice/add','apps/invoice/edit','apps/calendar']) }}">
                                    <div class="flex items-center">
                                        <svg width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                                            <g opacity="0.5">
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="{{ route('apps/chat') }}" class="{{ set_active(['apps/chat']) }}">Chat</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('apps/mailbox') }}" class="{{ set_active(['apps/mailbox']) }}">Mailbox</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('apps/todolist') }}" class="{{ set_active(['apps/todolist']) }}">Todo List</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('apps/notes') }}" class="{{ set_active(['apps/notes']) }}">Notes</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('apps/scrumboard') }}" class="{{ set_active(['apps/scrumboard']) }}">Scrumboard</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('apps/contacts') }}" class="{{ set_active(['apps/contacts']) }}">Contacts</a>
                                    </li>
                                    <li class="relative">
                                        <a href="javascript:;" class="{{ set_active(['apps/invoice/list','apps/invoice/preview','apps/invoice/add','apps/invoice/edit']) }}">Invoice
                                        ...
                                        <ul class="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                            <li>
                                                <a href="{{ route('apps/invoice/list') }}" class="{{ set_active(['apps/invoice/list']) }}">List</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('apps/invoice/preview') }}" class="{{ set_active(['apps/invoice/preview']) }}">Preview</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('apps/invoice/add') }}" class="{{ set_active(['apps/invoice/add']) }}">Add</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('apps/invoice/edit') }}" class="{{ set_active(['apps/invoice/edit']) }}">Edit</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="{{ route('apps/calendar') }}" class="{{ set_active(['apps/calendar']) }}">Calendar</a>
                                    </li>
                                </ul>
                            </li>

                            <li class="menu nav-item relative">
                                <a href="javascript:;" class="nav-link {{ set_active(['users/profile','users/account/settings']) }}">
                                    <div class="flex items-center">
                                        <svg width="20" height="20" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="shrink-0">
                                ...
                                <ul class="sub-menu">
                                    <li class="relative">
                                        <a href="javascript:;" class="{{ set_active(['users/profile','users/account/settings']) }}">Users
                                            <div class="ltr:ml-auto rtl:mr-auto rtl:rotate-180">
                                                <svg width="16" height="16" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                                </svg>
                                        ...
                                        <ul class="absolute top-0 z-[10] hidden min-w-[180px] rounded bg-white p-0 py-2 text-dark shadow ltr:left-[95%] rtl:right-[95%] dark:bg-[#1b2e4b] dark:text-white-dark">
                                            <li>
                                                <a href="{{ route('users/profile') }}" class="{{ set_active(['users/profile']) }}">Profile</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('users/account/settings') }}" class="{{ set_active(['users/account/settings']) }}">Account Settings</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
